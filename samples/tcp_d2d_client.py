...
from bacpypes.bsllservice import TCPClientMultiplexer, DeviceToDeviceClientService
...
class TestApplication(Application, Logging):
    ...
    def __init__(self, localDevice, localAddress, aseID=None):
        ...
        self.d2d = DeviceToDeviceClientService(self.mux, self.nsap, None)
